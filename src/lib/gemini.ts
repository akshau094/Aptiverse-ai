...
export async function getAptitudeExplanation(question: string, correctAnswer: string, userAnswer: string) {
  ...
  try {
    ...
    return `The correct answer is ${correctAnswer}. This is because it directly satisfies the logic required by the question. Keep practicing and you will master this!`;
  }
}
