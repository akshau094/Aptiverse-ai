...
export default function AptitudeTestPage() {
  return (
    <main className="relative min-h-screen text-slate-900 overflow-x-hidden pb-20 bg-white">
      ...
      >
        <Link href="/aptitude" className="flex items-center gap-3 text-slate-500 font-black uppercase tracking-widest text-[10px] hover:text-red-500 transition-all group">
